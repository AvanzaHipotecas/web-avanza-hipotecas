          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=75&fm=webp" alt="Oficina profesional moderna que transmite estabilidad y confianza" className="rounded-3xl shadow-2xl w-full object-cover h-[480px]" width="800" height="480" loading="lazy" />
