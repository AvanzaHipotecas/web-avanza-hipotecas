          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1503174971373-b1f69850bded?w=800&q=75&fm=webp" alt="Vivienda en proceso de reforma" className="rounded-3xl shadow-2xl w-full object-cover h-[480px]" width="800" height="480" loading="lazy" />
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Link to="/hipoteca-100" className="bg-white rounded-2xl p-5 flex items-start gap-4 hover:shadow-md transition-shadow border border-gray-100 hover:border-[#2EBFA5]/40 group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Si tampoco tienes ahorros para la entrada, descubre cómo financiar el 100% del precio de compraventa</p>
                </div>
                <ArrowRight className="w-4 h-4 text-gray-400 flex-shrink-0 group-hover:text-[#2EBFA5] transition-colors" />
              </Link>
              <Link to="/hipoteca-no-residentes" className="bg-white rounded-2xl p-5 flex items-start gap-4 hover:shadow-md transition-shadow border border-gray-100 hover:border-[#2EBFA5]/40 group">
                <div className="w-10 h-10 bg-[#2EBFA5]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <FileText className="w-5 h-5 text-[#2EBFA5]" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-[#1A3C40] group-hover:text-[#2EBFA5] transition-colors text-sm">Hipoteca para No Residentes</p>
                  <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">¿Compras desde el extranjero o eres no residente fiscal en España? Tenemos la hipoteca para tu perfil</p>
                </div>
                <ArrowRight className="w-4 h-4 text-gray-400 flex-shrink-0 group-hover:text-[#2EBFA5] transition-colors" />
              </Link>
            </div>
