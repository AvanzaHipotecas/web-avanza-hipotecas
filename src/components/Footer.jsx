  ...
  return <footer className="bg-[#1A3C40] text-white">
          ...
          once: true
                ...
                <div className="flex items-center space-x-2 mb-6">
                   <img src="https://horizons-cdn.hostinger.com/46b65610-3610-4aaa-b75e-344adbd2c5fe/logofooter-ohN7n.png" alt="Logo de Avanza Hipotecas para el pie de página" className="h-14 w-auto" width="200" height="56" loading="lazy" />
                </div>
