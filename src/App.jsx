...
const SubidaEuribor2026              = lazy(() => import('@/pages/blog/SubidaEuribor2026'));
const BrokerVsBanco                  = lazy(() => import('@/pages/blog/BrokerVsBanco'));
      ...
      <Suspense fallback={<div className="min-h-screen" />}>
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/blog/subida-euribor-junio-2026"                    element={<SubidaEuribor2026 />} />
            <Route path="/blog/broker-hipotecario-vs-banco"                  element={<BrokerVsBanco />} />
