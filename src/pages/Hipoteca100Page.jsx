          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80" alt="Pareja recibiendo las llaves de su nueva vivienda" className="rounded-3xl shadow-2xl w-full object-cover h-[480px]" />
